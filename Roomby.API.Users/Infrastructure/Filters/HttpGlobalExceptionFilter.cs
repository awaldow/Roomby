...
using Roomby.API.Users.Infrastructure.ActionResults;
using Roomby.API.Users.Infrastructure.Exceptions;
using System.Net;

namespace Roomby.API.Users.Infrastructure.Filters
{
    public class HttpGlobalExceptionFilter : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
            ...
            if (context.Exception.GetType() == typeof(UsersDomainException))
            {
